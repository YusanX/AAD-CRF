...
from aadcrf.training import train_avgc_icassp2023 as icassp_base

ExperimentConfig = icassp_base.ExperimentConfig
...
def load_config(path: str | Path) -> ExperimentConfig:
    cfg = icassp_base.load_config(path)
...
def run_experiment(cfg: ExperimentConfig) -> dict[str, float]:
    ...
    return icassp_base.run_experiment(cfg)
