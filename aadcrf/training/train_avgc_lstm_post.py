...
from aadcrf.training import train_avgc_lstm as lstm_base

ExperimentConfig = lstm_base.ExperimentConfig
...
def load_config(path: str | Path) -> ExperimentConfig:
    cfg = lstm_base.load_config(path)
...
def run_experiment(cfg: ExperimentConfig) -> dict[str, float]:
    ...
    return lstm_base.run_experiment(cfg)
