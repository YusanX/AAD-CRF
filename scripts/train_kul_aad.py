...
from aadcrf.training.train_kul_aad import load_kul_config, run_kul_experiment


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train AADNet with end-to-end CRF on KUL AAD dataset."
    )
    parser.add_argument(
        "--config",
        type=str,
        default=str(PROJECT_ROOT / "configs" / "kul_aadnet.yaml"),
