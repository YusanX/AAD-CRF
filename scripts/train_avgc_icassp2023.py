...
from aadcrf.training.train_avgc_icassp2023 import (
    ExperimentConfig,
    load_config,
    run_experiment,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train ICASSP2023 model with end-to-end CRF on AVGC AAD dataset."
    )
    parser.add_argument(
        "--config",
        type=str,
        default=str(PROJECT_ROOT / "configs" / "avgc_icassp2023.yaml"),
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        choices=["dilation", "mha_dc", "mha_gru_dc"],
        help="Override experiment.icassp2023_variant from config.",
    )
    parser.add_argument(
...
def main() -> None:
    ...
    if args.variant is not None:
        cfg.icassp2023_variant = args.variant
