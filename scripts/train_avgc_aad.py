...
from aadcrf.training.train_avgc_aad import load_config, run_experiment


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train AADNet with end-to-end CRF on AVGC AAD dataset."
    )
    parser.add_argument(
        "--config",
        type=str,
        default=str(PROJECT_ROOT / "configs" / "avgc_aadnet.yaml"),
