...
from aadcrf.training.train_avgc_lstm import ExperimentConfig, load_config, run_experiment


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train LSTMTracker with end-to-end CRF on AVGC AAD dataset."
    )
    parser.add_argument(
        "--config",
        type=str,
        default=str(PROJECT_ROOT / "configs" / "avgc_lstm.yaml"),
